...
Let me know if you'd like the corresponding sample data (`INSERT INTO` statements) for these tables too.
```
...
```sql
SELECT emp_id, ename, salary, to_char(hire_date, 'MONTH DD,YYYY') FROM emp_bn;
```
